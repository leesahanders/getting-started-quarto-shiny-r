...
```r
# Add your API Key from OpenAI, as needed
...
![](https://i1.wp.com/www.business-science.io/assets/080_chattr_diagram.jpg?w=578&ssl=1){width="80%"}
...
Make M models with [vetiver](https://rstudio.github.io/vetiver-r/)
...
Ferryland [deployed materials](https://pub.current.posit.team/ferries-overview/) and [deployed materials landing page](https://pub.current.posit.team/connect/#/apps/f6b2cd8d-5bd7-42ba-82cb-c25078918043/access/57) (currently only available to Posit employees). 
